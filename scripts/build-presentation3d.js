...
/* ── 챕터(캡션 = 나레이션 대본 그대로) ── */
const CH = `
  { kicker:"PROLOGUE", title:"운영계획 한눈에", color:"#ffb02e",
  ...
  { kicker:"STRUCTURE", title:"추진체계 — 사람", color:"#4f8df7",
  ...
  { kicker:"PHASE 01", title:"개인프로젝트", color:"#a07bf0",
  ...
  { kicker:"SELECTION", title:"48 → 5", color:"#ffc94d",
  ...
  { kicker:"PHASE 02 · SPIN-OFF", title:"기관컨설팅", color:"#2fd07a",
  ...
  { kicker:"PHASE 03", title:"팀프로젝트", color:"#f2617a",
  ...
  { kicker:"AWARDS & SUPPORT", title:"별개의 두 예산", color:"#ffc94d",
...
const ZONES = `function buildZones() {
  ...
  st(z, makeText("개인으로 증명하고, 팀으로 완성한다", { size: 1.1, color: C.amber, weight: 700 }), 1, [0, 25.6, 6]);
  const stats = [
    ["48명", "정원 · 1기+2기", C.gold, -11],
    ["12팀", "팀프로젝트", C.blue, -3.7],
    ["5기관", "파생 · 컨설팅", C.violet, 3.7],
    ["10월말", "전체 완료", C.green, 11]
  ];
  ...
  st(z, makeArrow([[-19.5, 18, -55], [-16.5, 18.8, -54.5], [-13.5, 18, -55]], C.amber, { packets: 1 }), 2, [0, 0, 0]);
  ...
  st(z, makeArrow([[12.5, 18, -55], [15.5, 18.8, -54.5], [18, 18, -55]], C.green, { packets: 1 }), 3, [0, 0, 0]);
  ...
  st(z, makeText("목요일 = 1기 · 금요일 = 2기", { size: .8, color: C.dim, weight: 700 }), 1, [-30, 10.6, 1]);
